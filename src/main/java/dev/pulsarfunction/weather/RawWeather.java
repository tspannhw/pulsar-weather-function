...
public class RawWeather{
    public Object noNamespaceSchemaLocation;
    public double version;
    public String credit;
    public String credit_URL;
    public Image image;
    public String suggested_pickup;
    public int suggested_pickup_period;
    ...
    public Object getNoNamespaceSchemaLocation() {
        return noNamespaceSchemaLocation;
    }

    public void setNoNamespaceSchemaLocation(Object noNamespaceSchemaLocation) {
        this.noNamespaceSchemaLocation = noNamespaceSchemaLocation;
    }
    ...
    public String toString() {
        return new StringJoiner(", ", RawWeather.class.getSimpleName() + "[", "]")
                .add("noNamespaceSchemaLocation=" + noNamespaceSchemaLocation)
                .add("version=" + version)
                .add("credit='" + credit + "'")
                .add("credit_URL='" + credit_URL + "'")
                .add("image=" + image)
                .add("suggested_pickup='" + suggested_pickup + "'")
                .add("suggested_pickup_period=" + suggested_pickup_period)
                ...
                .add("ob_url='" + ob_url + "'")
                .add("disclaimer_url='" + disclaimer_url + "'")
                .add("copyright_url='" + copyright_url + "'")
                .add("privacy_policy_url='" + privacy_policy_url + "'")
                .toString();
    }
}
